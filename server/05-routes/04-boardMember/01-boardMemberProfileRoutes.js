...
const {BoardMemberImagesUpload} = require("../../03-middlewares/imageUpload")

router.post("/create-board-member-profile", BoardMemberImagesUpload, CreateBoardMemberProfile)
